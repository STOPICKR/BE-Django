...
from stocks.views import FetchAllStocksInfoView, StockSearchView, AddStockToWeeklyView, WeeklyStocksView
...
urlpatterns = [
    ...
    # 주차별 주식 목록 (GET)
    path('weekly/', WeeklyStocksView.as_view(), name='weekly_stocks'),
    # 주차별 주식 추가 (POST)
    path('weekly/<int:stock_id>/', AddWeeklyStocksView.as_view(), name='add_weekly_stock'),
